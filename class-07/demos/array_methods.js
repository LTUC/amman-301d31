...
// let testString = 'helllo world 301'; // ['hello','orld']
...
// let output = strArr.splice(2,'cute'); // at position 2 remove 0 items and add 1 items
// console.log(strArr);
// console.log(output);
...
// let res = str2.slice(3,7); //7 does not included
// console.log(str2); // Hello world!
// console.log(res); // lo w
